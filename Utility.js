function createSummaryTable(battleReportObject){ // ToDo: Woher die insgesamten Daten holen?
    ...
    trooppoints_value_loser.innerHTML = addThousandsSep(666); // ToDo: Einfärben
    ...
    attack_value_winner.innerHTML = addThousandsSep(666); // ToDo: Einfärben

    let attack_name_loser = attack.insertCell(2);
    attack_name_loser.innerHTML = "Angriff";
    let attack_value_loser = attack.insertCell(3);
    attack_value_loser.innerHTML = addThousandsSep(666); // ToDo: Einfärben
    ...
    defense_value_winner.innerHTML = addThousandsSep(666); // ToDo: Einfärben
    ...
    defense_value_loser.innerHTML = addThousandsSep(666); // ToDo: Einfärben
    ...
    life_value_winner.innerHTML = addThousandsSep(666); // ToDo: Einfärben

    let life_name_loser = life.insertCell(2);
    life_name_loser.innerHTML = "Leben";
    let life_value_loser = life.insertCell(3);
    life_value_loser.innerHTML = addThousandsSep(666); // ToDo: Einfärben    
    ...
    mana_value_winner.innerHTML = addThousandsSep(666); // ToDo: Einfärben

    let mana_name_loser = mana.insertCell(2);
    mana_name_loser.innerHTML = "Mana";
    let mana_value_loser = mana.insertCell(3);
    mana_value_loser.innerHTML = addThousandsSep(666); // ToDo: Einfärben    
    ...
    exp_value_winner.innerHTML = addThousandsSep(666); // ToDo: Einfärben

    let exp_name_loser = exp.insertCell(2);
    exp_name_loser.innerHTML = "Erfahrung";
    let exp_value_loser = exp.insertCell(3);
    exp_value_loser.innerHTML = addThousandsSep(666); // ToDo: Einfärben    
    ...
    stone_value_winner.innerHTML = addThousandsSep(666); // ToDo: Einfärben

    let stone_name_loser = stone.insertCell(2);
    stone_name_loser.innerHTML = "Steinkosten";
    let stone_value_loser = stone.insertCell(3);
    stone_value_loser.innerHTML = addThousandsSep(666); // ToDo: Einfärben    
    ...
    mushrooms_value_winner.innerHTML = addThousandsSep(666); // ToDo: Einfärben
    ...
    mushrooms_value_loser.innerHTML = addThousandsSep(666); // ToDo: Einfärben    
